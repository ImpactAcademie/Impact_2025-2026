...
# Une classe Ball qui hérite de GameObject crée avec (x, y) de taille (15, 15) et couleur (BLUE) de vitesse (4, 4) avec une méthode update(paddles, scores): Bouger, Rebondir sur les platformes et le murs, gérer les sorties
"""Balle qui rebondit sur les murs et les raquettes"""
class Ball(GameObject):
    def __init__(self, x, y):
        super().__init__(x, y, 15, 15, BLUE)
        self.vx = 4
        self.vy = 4
